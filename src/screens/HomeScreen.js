...
const HomeScreen = () => {
  ...
  >
    ...
    <Text style={styles.featureText}>Breathing{'\n'}Exercise</Text>
        ...
        <TouchableOpacity style={styles.featureButton} onPress={() => navigation.navigate('PositiveAffirmationScreen')}>
          <Ionicons name="heart-outline" size={30} color={COLORS.prussianBlue} />
          <Text style={styles.featureText}>Positive{'\n'}Affirmations</Text>
        </TouchableOpacity>

        <TouchableOpacity style={styles.featureButton} onPress={() => navigation.navigate('CalmingVisualsScreen')}>
      ...
      <TouchableOpacity style={styles.communityButton} onPress={() => navigation.navigate('CommunityFundraiserScreen')}>
      ...
      <View style={styles.bottomNavContainer}>
        ...
        {/* Center Logo Button */}
        <TouchableOpacity style={styles.centerLogoContainer}onPress={() => navigation.navigate('ChatBotStart')}>
